...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "San Diego Padres") {
            return d;
        }
    })
    ...
    svg.append("text")
        ...
        .text("San Diego Padres Draft History by WAR")
        .classed("padres_title", true)
        ;
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("padres_active", true)
                        .classed("padres_inactive", false);
                    TC_WAR
                        .classed("padres_active", false)
                        .classed("padres_inactive", true);
                }
                else {
                    Career_WAR
