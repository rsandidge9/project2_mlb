...
<<<<<<< HEAD
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "Miami Marlins") {
            return d;
        }
    })
    ...
    svg.append("text")
        ...
        .text("Miami Marlins Draft History by WAR")
        .classed("marlins_title", true)
        ;
    ...
    var Career_WAR = labelsGroup.append("text")
        ...
        .classed("marlins_inactive", true)
        .classed("marlins_axis-text", true)
        .text("Career WAR");
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("marlins_active", true)
                        .classed("marlins_inactive", false);
                    TC_WAR
                        .classed("marlins_active", false)
                        .classed("marlins_inactive", true);
                }
                else {
                    Career_WAR
