...
function updateToolTip(chosenYAxis, circlesGroup) {
    ...
    var toolTip = d3.tip()
        .attr("class", "diamondbacks_tooltip")
        .offset([80, -60])
        .html(function (d) {
...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "Arizona Diamondbacks") {
            return d;
        }
    })
    ...
    var circlesGroup = chartGroup.selectAll("rect")
        ...
        .classed("diamondbacks_inactive", true)
    ...
    svg.append("text")
        ...
        .text("Arizona Diamondbacks Draft History by WAR")
        .classed("diamondbacks_title", true)
        ;
    ...
    var TC_WAR = labelsGroup.append("text")
        ...
        .classed("active", true)
        .classed("diamondbacks_axis-text", true)
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("diamondbacks_active", true)
                        .classed("diamondbacks_inactive", false);
                    TC_WAR
                        .classed("diamondbacks_active", false)
                        .classed("diamondbacks_inactive", true);
                }
                else {
                    Career_WAR
