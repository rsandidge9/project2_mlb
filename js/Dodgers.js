...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "Los Angeles Dodgers") {
            return d;
        }
    })
    ...
    svg.append("text")
        ...
        .text("Loas Angeles Dodgers Draft History by WAR")
        .classed("dodgers_title", true)
        ;
    ...
    var TC_WAR = labelsGroup.append("text")
        ...
        .classed("active", true)
        .classed("dodgers_axis-text", true)
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("dodgers_active", true)
                        .classed("dodgers_inactive", false);
                    TC_WAR
                        .classed("dodgers_active", false)
                        .classed("dodgers_inactive", true);
                }
                else {
                    Career_WAR
