...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "Minnesota Twins") {
            return d;
        }
    })
    ...
    svg.append("text")
        ...
        .text("Minnesota Twins Draft History by WAR")
        .classed("twins_title", true)
        ;
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("twins_active", true)
                        .classed("twins_inactive", false);
                    TC_WAR
                        .classed("twins_active", false)
                        .classed("twins_inactive", true);
                }
                else {
                    Career_WAR
