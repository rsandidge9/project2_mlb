...
=======
  ...
  bottom: 80,
  left: 100
>>>>>>> a5fa689b7b82665c0f88d11ca07e039f418222e2
};
...
<<<<<<< HEAD
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "Philadelphia Phillies") {
            return d;
        }
    })
    ...
    svg.append("text")
        ...
        .text("Philadelphia Phillies Draft History by WAR")
        .classed("phillies_title", true)
        ;
    ...
    var Career_WAR = labelsGroup.append("text")
        ...
        .classed("phillies_inactive", true)
        .classed("phillies_axis-text", true)
        .text("Career WAR");
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("phillies_active", true)
                        .classed("phillies_inactive", false);
                    TC_WAR
                        .classed("phillies_active", false)
                        .classed("phillies_inactive", true);
                }
                else {
                    Career_WAR
