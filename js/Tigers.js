...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
    ...
    svg.append("text")
        ...
        .text("Detroit Tigers Draft History by WAR")
        .classed("tigers_title", true)
        ;
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("tigers_active", true)
                        .classed("tigers_inactive", false);
                    TC_WAR
                        .classed("tigers_active", false)
                        .classed("tigers_inactive", true);
                }
                else {
                    Career_WAR
