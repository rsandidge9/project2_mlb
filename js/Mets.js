...
<<<<<<< HEAD
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "New York Mets") {
            return d;
        }
    })
    ...
    svg.append("text")
        ...
        .text("New York Mets Draft History by WAR")
        .classed("mets_title", true)
        ;
    ...
    var Career_WAR = labelsGroup.append("text")
        ...
        .classed("mets_inactive", true)
        .classed("mets_axis-text", true)
        .text("Career WAR");
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("mets_active", true)
                        .classed("mets_inactive", false);
                    TC_WAR
                        .classed("mets_active", false)
                        .classed("mets_inactive", true);
                }
                else {
                    Career_WAR
