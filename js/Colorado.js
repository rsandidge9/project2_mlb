...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "Colorado Rockies") {
            return d;
        }
    })
    ...
    svg.append("text")
        ...
        .text("Colorado Rockies Draft History by WAR")
        .classed("rockies_title", true)
        ;
    ...
    var TC_WAR = labelsGroup.append("text")
        ...
        .classed("active", true)
        .classed("rockies_axis-text", true)
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("rockies_active", true)
                        .classed("rockies_inactive", false);
                    TC_WAR
                        .classed("rockies_active", false)
                        .classed("rockies_inactive", true);
                }
                else {
                    Career_WAR
