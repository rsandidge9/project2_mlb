...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "San Francisco Giants") {
            return d;
        }
    })
    ...
    svg.append("text")
        ...
        .text("San Fransisco Giants Draft History by WAR")
        .classed("giants_title", true)
        ;
    ...
    var Career_WAR = labelsGroup.append("text")
        ...
        .classed("giantss_inactive", true)
        .classed("giants_axis-text", true)
        .text("Career WAR");
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("giants_active", true)
                        .classed("giants_inactive", false);
                    TC_WAR
                        .classed("giants_active", false)
                        .classed("giants_inactive", true);
                }
                else {
                    Career_WAR
