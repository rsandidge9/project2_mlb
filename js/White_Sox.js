...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "Chicago White Sox") {
            return d;
        }
    })
    ...
    var barGroup = chartGroup.selectAll("rect")
        ...
        .classed("white_sox_inactive", true)
    ...
    svg.append("text")
        ...
        .text("Chicago White Sox Draft History by WAR")
        .classed("white_sox_title", true)
        ;
    ...
    var TC_WAR = labelsGroup.append("text")
        ...
        .classed("active", true)
        .classed("white_sox_axis-text", true)
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("white_sox_active", true)
                        .classed("white_sox_inactive", false);
                    TC_WAR
                        .classed("white_sox_active", false)
                        .classed("white_sox_inactive", true);
                }
                else {
                    Career_WAR
