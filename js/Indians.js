...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
    ...
    var FranchiseTeamData = teamData.filter(function (d) {
        if (d["Current_Franchise"] == "Cleveland Indians") {
            return d;
        }
    })
    ...
    svg.append("text")
        ...
        .text("Clevland Indians Draft History by WAR")
        .classed("indians_title", true)
        ;
    ...
    var TC_WAR = labelsGroup.append("text")
        ...
        .classed("active", true)
        .classed("indians_axis-text", true)
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("indians_active", true)
                        .classed("indians_inactive", false);
                    TC_WAR
                        .classed("indians_active", false)
                        .classed("indians_inactive", true);
                }
                else {
                    Career_WAR
