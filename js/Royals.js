...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
    ...
    svg.append("text")
        ...
        .text("Kansas City Royals Draft History by WAR")
        .classed("royals_title", true)
        ;
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "Career_Total_WAR") {
                    Career_WAR
                        .classed("royals_active", true)
                        .classed("royals_inactive", false);
                    TC_WAR
                        .classed("royals_active", false)
                        .classed("royals_inactive", true);
                }
                else {
                    Career_WAR
